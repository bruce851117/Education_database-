...
# 修改 20201201
industryProdepartment = pd.read_excel('./data/0_科系_學院分類.xlsx')
industryProdepartment_exception = pd.read_excel('./data/0_科系_學院分類_例外.xlsx')
    ...
    def getManagerDict():  # 各產業高階經理人的關鍵字、專業學院
        ...
        managerDict = {'總經理':
                           {'包含':'總經理|執行長|總裁',
                            ...
                            '專業科系':f'{manage_department}|{industryProdepartment_exception}|{industryProdepartment}'
                            },
                       '財務長':
                           {'身份別':'財務主管|財會主管',
                            '包含':'財務長',
                       ...
                       '法遵長':
                           ...
                           '專業科系':f'{law_department}|{industryProdepartment_exception}|{industryProdepartment}'
                           },
                       '法務長':
                           {'職稱':'法務|法律事務',
                       ...
                       '資安長':
                            {'職稱':'資安|資訊安全',
                             ...
                             '專業學院':'電機資訊學院',
                             '專業科系':f'{ciber_secure_department}'
                             }
